...
2) `Пользовательские страницы:`
   ...
   - ***recipient_form_add_new.html***: страница для добавления в список нового Получателя рассылки (модель данных **Recipient**).
     - Функционал страницы:
...
2) Класс-контроллер `RecipientCreateView(generic.CreateView)` - представление для отображения страницы *recipient_form_add_new.html* с добавлением в список нового Получателя рассылки.
